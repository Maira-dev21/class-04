...
//scope 
var a : number = 10; // global scope variable
{
    var b: string ="maira"
    {
      var c : boolean = true
...
//unshift add value
let mystudents : string[] = ["sadia","laiba"]
mystudents.shift()
...
//name.splice(1,1)
//indexof
let names : string[] =["abc ","dfg"]
console.log(names. indexOf("dfg"))
//addition splice
let Names : string[]=["ali","huzafa","hamza"]
